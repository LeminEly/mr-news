...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'fr': {
      ...
      'reset_code_hint': 'Entrez le code à 8 chiffres reçu par email.',
    ...
    'en': {
      ...
      'reset_code_hint': 'Enter the 8-digit code sent to your email.',
    ...
    'ar': {
      ...
      'reset_code_hint': 'أدخل الرمز المكون من 8 أرقام المرسل إلى بريدك.',
